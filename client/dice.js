...
(function(dice) {
    ...
    this.dice_color = '#CBB436'; // yellow
    this.dice_color = '#074D25'; // green
    this.dice_color = '#184261'; // dark blue
    this.dice_color = '#0067B5'; // light blue
    this.dice_color = '#562C5B'; // purple
    this.dice_color = '#A85225'; // orange
    this.dice_color = '#B53030'; // red
    this.dice_color = '#87DF1E'; // light green
    this.dice_color = '#A6A6A6'; // white
    this.dice_color = '#202020'; // black
